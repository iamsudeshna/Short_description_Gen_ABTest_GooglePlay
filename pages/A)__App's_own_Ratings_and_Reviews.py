...
"""
Created on Tue Nov 19 23:37:10 2024
@author: sudeshna kundu
"""
...
st.subheader("This is Instabridge's own Ratings and Reviews")
st.header("About This Page")
st.write("This page shows us the analysis of the App from its recent 200 ratings and reviews, which will also play a part in setting context for short description generation.The data is web-scraped from playstore")
# Fetching reviews for the Instabridge app
app_id = "com.instabridge.android"  # App ID for Instabridge on Google Play
...
reviews_df.to_csv("../instabridge_reviews.csv", index=False)
